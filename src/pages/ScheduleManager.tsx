      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-3 sm:mb-4 md:mb-6 gap-3 shrink-0">
        <div className="flex flex-col gap-2 w-full md:w-auto">
          <div className="flex flex-wrap items-center justify-between md:justify-start gap-3">
            ...
            <div className="flex items-center gap-1.5 bg-[#051326] border border-[#1e3a5f] rounded-lg px-2.5 sm:px-3.5 py-1 shrink-0">
              ...
              <select
                ...
                className="bg-transparent text-xs sm:text-sm md:text-base text-white focus:outline-none appearance-none cursor-pointer"
              >
                <option value="all" className="bg-[#08172c]">모든 통역사</option>
                {role === 'counselor' ? (
                  <option value={user?.uid} className="bg-[#08172c]">내 일정</option>
                ) : (
          ...
          <div className="flex flex-wrap items-center gap-2 mt-0.5">
            <div className="flex items-center gap-1.5 shrink-0 whitespace-nowrap"><div className="w-2.5 h-2.5 rounded-full bg-red-500/80 border border-red-500"></div><span className="text-[11px] text-[#94a3b8]">네팔</span></div>
            <div className="flex items-center gap-1.5 shrink-0 whitespace-nowrap"><div className="w-2.5 h-2.5 rounded-full bg-yellow-500/80 border border-yellow-500"></div><span className="text-[11px] text-[#94a3b8]">베트남</span></div>
            <div className="flex items-center gap-1.5 shrink-0 whitespace-nowrap"><div className="w-2.5 h-2.5 rounded-full bg-blue-500/80 border border-blue-500"></div><span className="text-[11px] text-[#94a3b8]">태국</span></div>
            <div className="flex items-center gap-1.5 shrink-0 whitespace-nowrap"><div className="w-2.5 h-2.5 rounded-full bg-green-500/80 border border-green-500"></div><span className="text-[11px] text-[#94a3b8]">우즈베키스탄</span></div>
            <div className="flex items-center gap-1.5 shrink-0 whitespace-nowrap"><div className="w-2.5 h-2.5 rounded-full bg-purple-500/80 border border-purple-500"></div><span className="text-[11px] text-[#94a3b8]">인도네시아</span></div>
            <div className="flex items-center gap-1.5 shrink-0 whitespace-nowrap"><div className="w-2.5 h-2.5 rounded-full bg-orange-500/80 border border-orange-500"></div><span className="text-[11px] text-[#94a3b8]">스리랑카</span></div>
          </div>
        </div>
      </div>
      
      <div className={`bg-apple-gray/20 rounded-[20px] md:rounded-[24px] border border-apple-border p-2 md:p-4 backdrop-blur-xl apple-calendar flex flex-col ${isMobile ? 'h-auto flex-none' : 'flex-1 min-h-0 overflow-hidden'}`}>
