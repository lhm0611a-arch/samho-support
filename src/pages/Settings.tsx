    ...
    <div className="flex flex-col h-full gap-4 md:gap-6 animate-fade-in-up pb-8">
      ...
      <div className="dx-card p-6 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-white flex items-center gap-2">
                AI 분석 모델 및 토큰 최적화 (실적 보고서 & 긴급 상담 챗봇)
                <span className="text-xs px-2 py-0.5 rounded-full bg-green-500/10 text-green-400 border border-green-500/30 font-normal">
                  유료 모델 비용 최소화 모드 활성
                </span>
              </h3>
              <p className="text-xs text-gray-400 mt-0.5">
                실적 보고서 생성 및 외국인 긴급 상담 챗봇 전체에 초저비용 고성능 유료 Gemini 모델이 일괄 적용되었습니다.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-4 rounded-xl bg-[#051326] border border-[#1e3a5f]">
            <span className="text-gray-400 block mb-1">기본 적용 모델</span>
            <span className="font-bold text-cyan-400 text-sm block">gemini-3.1-flash-lite</span>
            <span className="text-[11px] text-gray-500 mt-1 block">초저비용($0.075/1M 토큰), 초고속 다국어 실시간 스트리밍, 미사여구 배제</span>
          </div>
          <div className="p-4 rounded-xl bg-[#051326] border border-[#1e3a5f]">
            <span className="text-gray-400 block mb-1">장애 시 자동 폴백</span>
            <span className="font-bold text-blue-400 text-sm block">gemini-3.8-flash → pro-preview</span>
            <span className="text-[11px] text-gray-500 mt-1 block">트래픽 급증 또는 일시 지연 시 무중단 자동 단계별 전환</span>
          </div>
          <div className="p-4 rounded-xl bg-[#051326] border border-[#1e3a5f]">
            <span className="text-gray-400 block mb-1">대화 및 입력 토큰 최적화</span>
            <span className="font-bold text-green-400 text-sm block">대화 이력 최근 6턴 압축 / 최대 800토큰 제한</span>
            <span className="text-[11px] text-gray-500 mt-1 block">사내 참고 규정 2,000자 압축 및 핵심 요약 응답으로 토큰 과소비 원천 방지</span>
          </div>
        </div>
      </div>
